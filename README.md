...
а администраторам — управлять пользователями и выгружать данные.
...
git clone https://github.com/Foiboss/Telegram-bot
cd Telegram-bot
...
1. **Отредактировать переменне** `BotInfo.config.py`:
   ...
   ```
    TOKEN: str = "Ваш токен бота"
    WHITELIST_FILE: str = "whitelist.json"        # оставьте значение по умолчанию
    DB_PATH: str = "bot.db"                       # оставьте значение по умолчанию
    should_be_antispam_protected: bool = True     # установите True, если хотите, чтобы антиспам работал, или False, если не хотите
...
- Семенов Антон — основной разработчик, проработка логики связи частей кода, базы данных 
- Анна Лозбинева — фронтэнд, создание кнопок управления, визульной составляющей
